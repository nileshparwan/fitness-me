...
export function LogHealthSheet({
  open,
  subject,
  prefillRow,
  onClose,
    ...
    >
      ...
      >
        <AppSheetHeader className="border-b border-border/60 px-5 py-4">
          <AppSheetTitle>Log Today</AppSheetTitle>
          <AppSheetDescription>Log sleep, vitals, and activity for recovery tracking.</AppSheetDescription>
        </AppSheetHeader>
